...
try:
    ...
    while True:
        ...
        draw.text((170,80), '00,30', font = font24, fill = 0)
        draw.text((230,80), 'kW', font = font24, fill = 0)
        draw.text((170,104), '60,00', font = font24, fill = 0)
        draw.text((230,104), 'kWh', font = font24, fill = 0)
